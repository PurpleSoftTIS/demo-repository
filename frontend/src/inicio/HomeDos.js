...
const HomeDos = () => {
  ...
  return (
    ...
    <div className="col-md-6 d-flex flex-column align-items-center justify-content-center">
        ...
        <div> 
          <p className="text-center titulo-personalizado">Bienvenidos al Sistema de Reserva de Ambientes FCyT UMSS</p>
        ...
        <div>          
              <Link to="/Usuario/Usu/Solicitar" style={{backgroundColor: '#0d0d46', color: 'white'}} className="btn">Solicitudes</Link>
        </div>
