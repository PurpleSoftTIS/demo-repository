          ...
          <div className="card text-center">
            <div className="card-body">
              <div className="d-flex flex-column align-items-center"> 
                ...
                <h5 className="card-title">Configuración Exitosa</h5> 
              </div>
              <p className="parrafito">Su configuracion se guardo correctamente</p>
              <div>          
...
export default MensajeConfExitoso